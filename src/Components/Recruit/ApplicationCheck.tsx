...
export const ApplicationCheck = () => {
  ...
  return (
    <ApplicationWrapper style={{minHeight: 546}}>
      <ApplicationHeader>지원결과 확인</ApplicationHeader>
      <ApplicationContent>
        <ApplicationForm style={{marginTop: 0}}>
          <FormTitle>온라인 지원결과 확인하기</FormTitle>
          <FormPart>
          ...
          <FormPart>
            <button className='submit'>확인하기 <FaCaretRight /></button>
          </FormPart>
        </ApplicationForm>
      </ApplicationContent>
    </ApplicationWrapper>
...
export default React.memo(ApplicationCheck);