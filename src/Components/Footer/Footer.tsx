...
import { FooterIcon, FooterSocial, FooterSocials, FooterTxt, FooterWrapper } from './styles';
...
export const Footer = () => {
  return (
    <FooterWrapper>
      ...
      <FooterTxt style={{marginTop: 40}}>Copyright ⓒ STCO. All right reserved</FooterTxt>
      <FooterSocials>
